...
from framework.models.server import ServerModel, USBPortModel, USBPortStatus
...
class USB:
    ...
    def hard_reboot(self, usb_port: USBPortModel):
    ...
    def hard_turn_off(self, usb_port: USBPortModel, update_status = True):
        self.write("p" + str(usb_port.get_real_port()), IO_OFF)
        if update_status == True:
            usb_port.set_status(USBPortStatus.OFF)

    def hard_turn_on(self, usb_port: USBPortModel, update_status = True):
