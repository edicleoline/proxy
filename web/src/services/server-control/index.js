...
import { serverControlAction } from 'store/constant';
...
export const pendingReloadModemsInQueue = () => {
    ...
    return commands ? commands.filter((x) => x.status === commandStatus.pending && x.action === serverControlAction.modem.reload) : [];
};
